...
class ChidoriSprite(SkillSprite):
    ...
    def configAnimationService(self):
        self.idleAnimationService = TimingAnimationService([self.leftFrames[0], self.leftFrames[1]],
                                                           [self.rightFrames[0], self.rightFrames[1]], 0.05)

        self.moveAnimationService = TimingAnimationService([self.leftFrames[2], self.leftFrames[3]],
                                                           [self.rightFrames[2], self.rightFrames[3]], 0.05)


        self.hitAnimationService = TimingAnimationService(
            [self.leftFrames[4], self.leftFrames[5]],
            [self.rightFrames[4], self.rightFrames[5]], 0.05)
